...
//variabile che verifica se la mail contiene almeno un punto e almeno una chiocciola
$valid_mail = strpos($mail, '@') && strpos($mail, '.');
echo "-------------------------------------------------------------------------<br>";
echo 'CONTROLLO 2)<br>';
echo $mail.' contiene almeno un punto e almeno una chiocciola?:';
